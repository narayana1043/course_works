...
# it will take longer time to run compared to sklearn is because it can be threaded heavily and sklearn uses threading with n_jobs parameter
...
for i in range(25):
    ...
    # .values.tolist() is not to loose the relationship of the features when shuffled
